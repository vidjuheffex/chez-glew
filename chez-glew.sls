...
(library (glew)
  ...
  (define-function void glEdgeFlagPointer (int const void*))
  ...
  (define-function void glTexCoordPointer (int int int const void*))
  ...
  (define-function void glVertexPointer (int int int const void*))
