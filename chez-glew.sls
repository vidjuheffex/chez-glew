...
(library (glew)
  ...
  (define-function void glDeleteTextures (int int))
  ...
  (define-function void glEdgeFlagv (int))
  ...
  (define-function void glFogiv (int int))
  ...
  (define-function void glGenTextures (int int))
  ...
  (define-function void glGetTexLevelParameteriv (int int int int))
  (define-function void glGetTexParameterfv (int int float))
  (define-function void glGetTexParameteriv (int int int))
  ...
  (define-function void glPixelMapuiv (int int int))
  ...
  (define-function void glTexParameteriv (int int int))
